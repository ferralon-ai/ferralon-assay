...
func TestResolveVendored_OK(t *testing.T) {
	...
	got, lang, err := ResolveVendored(dir)
	if err != nil {
...
func TestResolveVendored_TypeScriptTree(t *testing.T) {
	...
	if _, _, err := ResolveVendored(dir); err == nil {
	...
	_, lang, err := ResolveVendored(dir)
	if err != nil {
...
func TestResolveVendored_MissingPath(t *testing.T) {
	if _, _, err := ResolveVendored(filepath.Join(t.TempDir(), "does-not-exist")); err == nil {
...
func TestResolveVendored_EmptyPath(t *testing.T) {
	if _, _, err := ResolveVendored(""); err == nil {
